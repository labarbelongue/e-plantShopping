...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Natural Gifts, life always find a way!</p>
      <p className="about-us-content">
        At Natural Gifts, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
